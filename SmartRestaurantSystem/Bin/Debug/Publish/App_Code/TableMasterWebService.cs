...
public class TableMasterWebService : System.Web.Services.WebService
{
    ...
    [WebMethod]
    public string TableMasterManage(Int32 TableID, String TableNo, String IPAddress)
    {
        String msg = "";
        ...
        try
        {
            if (TableID == 0)
            {
                ...
                cmd.Parameters.AddWithValue("@IPAddress", IPAddress).DbType = DbType.String;
    ...
    [WebMethod]  
    public string GetTableID(String IPAddress)
    {
        SqlConnection con = new SqlConnection(Global.StrCon);
        SqlCommand cmd = new SqlCommand("GetTableID", con);
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.Parameters.AddWithValue("@IPAddress", IPAddress).DbType = DbType.String;
        return GetDataWithoutPaging(cmd).GetXml();
    }
