                ...
                <div class="w-full  flex justify-center item-center">
                    ...
                    <div class="space-y-5 w-full ">
                        ...
                        <div class="font-semibold flex space-x-5  flex justify-center">
                            <div>
                                <input type="button" class="bg-yellow-900 font-bold text-white py-3 px-10 hover:bg-yellow-700 cursor-pointer" onclick="OrderItem();" name="btnmakepayement" value="Make Payment" />
                            </div>
        ...
        function callingRZP(customerInfo) {
            ...
            options.handler = function (response) {
                ...
                $.ajax({
                    ...
                    method: "POST",
                    data: "{TableID:" + JSON.stringify(localStorage.getItem("TableID")) + ", BillAmt:" + JSON.stringify(BillAmt) + ", PaymentMode:" + JSON.stringify(PaymentMode) + ",rzpPaymentID: " + JSON.stringify(paymentID) + ", rzpOrderID: " + JSON.stringify(rzporderID) + ", rzpSignature: " + JSON.stringify(sign) + "}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
                        var result = res.d;
        ...
        function OrderItem() {
            ...
            if (PaymentMode == "Online") {
                ...
                $.ajax({
                    ...
                    url: "../WebServices/OrderMasterWebService.asmx/OrderMasterInsert",
                    method: "POST",
                    data: "{TableID:" + JSON.stringify(localStorage.getItem("TableID")) + ", BillAmt:" + JSON.stringify(BillAmt) + ", PaymentMode:" + JSON.stringify(PaymentMode) + ",rzpPaymentID:'', rzpOrderID:'', rzpSignature:''}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (res) {
                        var result = res.d;
