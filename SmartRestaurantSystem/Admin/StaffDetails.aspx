                ...
                <div class="font-poppins-400 text-xl w-full space-y-12 px-5 py-5 font-bold">
                    ...
                    <div class="md:flex md:justify-center xl:items-end xl:justify-start ">
                        <div class="text-center min-w-[15rem]  h-[17rem] rounded-lg overflow-hidden ">
                            ...
                            <label for="fuStaffPhoto" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
