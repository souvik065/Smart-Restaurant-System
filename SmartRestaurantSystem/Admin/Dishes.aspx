...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="w-full my-5 shadow-2xl text-classic-yellow font-playfair-display-500 bg-classic-brown py-5 px-5">
            <div class="w-full">
                <div class="font-poppins-400 text-xl w-full space-y-12 px-5 py-5 font-bold">
                    ...
                    <!-- Fields -->
                    <div class="text-center items-end w-1/6 h-[17rem] rounded-lg overflow-hidden ">
                        <label for="fuDishPhoto" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            <img id="imgDishPhoto" alt="" src="#" style="display: none;" class="h-full w-full" />
    ...
    <script>
        ...
        $("#btnSave").on('click', function () {
            ...
            var Validate = FormValidation(categoryid, subcategoryid, ingredience, dishname, dishphoto);
            if (Validate == true) {
        ...
        function OnSuccess(response) {
            ...
            if (Details.length > 0) {
                $.each(Details, function () {
                    ...
                    strEditDelete += " <input class='bg-yellow-900 mx-2 text-center text-white py-3 px-5 hover:bg-yellow-700 cursor-pointer' onclick='EditDish(" + $(this).find("DishID").text() + ")' type='button' value='Edit' />";
                    strEditDelete += " <input class='bg-red-900 mx-2 text-center text-white py-3 px-5 hover:bg-red-600 cursor-pointer' onclick='DeleteDish(" + $(this).find("DishID").text() + ",\"" + $(this).find("DishPhoto").text() + "\")' type='button' value='Delete' />";
        ...
        function FormValidation(categoryid, subcategoryid, ingredience, dishname, dishphoto) {
            var returnval = true;
            debugger;
            if (categoryid.val() === 0) {
